...
:start
@start "" "League of Legends.exe" "spectator replays.leagueofgraphs.com:80 /wuUK+4nFA8k+As3IS+1mMIQSzSPMne+ 3523742676 EUN1-%RANDOM%%RANDOM%" -UseRads -GameBaseDir=.. "-Locale=%locale%" -SkipBuild -EnableCrashpad=true -EnableLNP
goto exit

...
:start
@start "" "League of Legends.exe" "spectator replays.leagueofgraphs.com:80 WVUs5/yly2DR0scyENksiWFKtag1EHbo 4883109903 NA1-%RANDOM%%RANDOM%" -UseRads -GameBaseDir=.. "-Locale=%locale%" -SkipBuild -EnableCrashpad=true -EnableLNP
goto exit

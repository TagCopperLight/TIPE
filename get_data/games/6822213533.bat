...
:start
@start "" "League of Legends.exe" "spectator replays.leagueofgraphs.com:80 /+n7bB3ldVzaWs+/kcmxd8r1guhObBTy 6822213533 KR-%RANDOM%%RANDOM%" -UseRads -GameBaseDir=.. "-Locale=%locale%" -SkipBuild -EnableCrashpad=true -EnableLNP
goto exit

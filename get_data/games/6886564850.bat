...
:start
@start "" "League of Legends.exe" "spectator replays.leagueofgraphs.com:80 eTQmq1blW37siygbgi1YX0BAM7xasTBN 6886564850 KR-%RANDOM%%RANDOM%" -UseRads -GameBaseDir=.. "-Locale=%locale%" -SkipBuild -EnableCrashpad=true -EnableLNP
goto exit

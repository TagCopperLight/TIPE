...
:start
@start "" "League of Legends.exe" "spectator replays.leagueofgraphs.com:80 if9zc/79Hjbs6r1kXJHHPkLLEwrswehc 2868248183 BR1-%RANDOM%%RANDOM%" -UseRads -GameBaseDir=.. "-Locale=%locale%" -SkipBuild -EnableCrashpad=true -EnableLNP
goto exit
